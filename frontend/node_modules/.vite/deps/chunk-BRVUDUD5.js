...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-K5NRACXP.js";
import {
  ChainNotConfiguredError,
  ProviderNotFoundError,
  createConnector,
  extractRpcUrls
} from "./chunk-M27YBQ2V.js";
import {
  import_index
} from "./chunk-V3GQ7CBF.js";
import {
  withRetry,
  withTimeout
} from "./chunk-IGPGBAPR.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-LJYHDIOO.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-CBO54Y76.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-OYOKD2V5.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-SBQSREQF.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-ZFOHGDYX.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-QWA6PR2B.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-IPIWMPGC.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-7Q3GATZZ.js");
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BRVUDUD5.js.map
