export const TASK_VAULT_ABI = [
  { inputs: [{ name: "user", type: "address" }], name: "getUserInfo", outputs: [{ name: "exists", type: "bool" }, { name: "tierIndex", type: "uint8" }, { name: "balance", type: "uint256" }, { name: "lifetimeEarned", type: "uint256" }, { name: "referralEarnings", type: "uint256" }, { name: "referralCount", type: "uint256" }, { name: "tasksCompleted", type: "uint256" }, { name: "tasksCorrect", type: "uint256" }, { name: "vaultBalance", type: "uint256" }, { name: "vaultMultiplier", type: "uint256" }, { name: "activeStreams", type: "uint256" }], stateMutability: "view", type: "function" },
